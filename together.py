...
def bot_answer(question, current_mood):
    ...
    try:
        ...
        if current_mood in ['Happy', 'Surprise']:
            prompt = f"""You are a Personal Therapist named Fido. Your goal is to uplift user mental health and engage in a deep human-like conversation. 
...
if __name__ == '__main__':
    print("\n🚀 FIDO is running at http://127.0.0.1:5000")
